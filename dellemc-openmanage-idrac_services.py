...
options:
    ...
    tls_protocol:
        ...
        choices: [TLS_1_0_and_Higher, TLS_1_1_and_Higher, TLS_1_2_Only, TLS_1_2_and_Higher, TLS_1_3_Only]
    https_port:
        type: int
    ...
    module = AnsibleModule(
        argument_spec=dict(
            ...
            tls_protocol=dict(required=False, choices=['TLS_1_0_and_Higher',
                                                       'TLS_1_1_and_Higher', 'TLS_1_2_Only',
                                                       'TLS_1_2_and_Higher', 'TLS_1_3_Only'], default=None),
