...
class iDRACConfig(iBaseConfigApi):
    ...
    def configure_web_server(self, enable_web_server=None, http_port=None, https_port=None, timeout=None,
        ...
        """
            ...
            :param tls_protocol: TLS Protocol. "TLS 1.0 and Higher" - TLS_1_0_and_Higher, "TLS 1.1 and Higher" - TLS_1_1_and_Higher, "TLS 1.2 Only" - TLS_1_2_Only, "TLS 1.2 and Higher" - TLS_1_2_and_Higher, "TLS 1.3 Only" - TLS_1_3_Only
